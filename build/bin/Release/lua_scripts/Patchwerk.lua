...
function Patchwerk.SummonOoze(eventId,delay,calls, creature)
    ...
    for i = 1, 4, 1 do
        ...
        creature:SpawnCreature(16375, x+rand_pos_list[1],y+rand_pos_list[2],z, o)
    end
end
...
RegisterCreatureEvent(16028, 1, Patchwerk.OnEnterCombat)
RegisterCreatureEvent(16028, 2, Patchwerk.OnLeaveCombat)
RegisterCreatureEvent(16028, 4, Patchwerk.OnDied)
RegisterCreatureEvent(16028, 5, Patchwerk.CheckHealth)
